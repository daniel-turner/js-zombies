...
function Player(name,health,strength,speed) {
  ...
  */
  this.checkPack = function() {
    ...
    var daPack = this.getPack();

    console.log("Pack contents: ");

    for(var i =0;i<daPack.length;i++) {

      console.log(daPack[i].name);
    };
  ...
  */
  this.discardItem = function(item) {
    ...
    if(index ===  -1) {
      ...
      console.log(item.name + " was not found in pack.");
      return false;
    }

    console.log(name + " discarded " + item.name);
    pack.splice(index,1);
  ...
  */
  this.equip = function(item) {
    ...
    if(!(item instanceof Weapon)) {
      ...
      console.log(item.name + " is not a weapon and cannot be equipped.");
      return;
    }
  ...
  */
  this.eat = function(itemToEat) {
    ...
    if(!(itemToEat instanceof Food)) {
      ...
      console.log(itemToEat.name + " is not food!");
      return;
    }
    ...
    if(index === -1) {
      ...
      console.log("Cannot find " + itemToEat.name + " in pack.");
      return;
    };
